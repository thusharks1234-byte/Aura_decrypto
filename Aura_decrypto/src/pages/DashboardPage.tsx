...
import { Plus, TrendingUp, Gavel, Clock, Award } from 'lucide-react';
import { getAuctions, triggerStatusTransitions, type Auction } from '../lib/supabase';
    ...
    <div style={{ minHeight: '100vh', background: '#050505', paddingTop: 64 }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <motion.div
          ...
          style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, marginBottom: 36 }}
        >
          <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: 12, marginBottom: 36 }}>
          {stats.map((s, i) => (
            ...
            >
              ...
              <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2rem', fontWeight: 800 }}>
                {s.value}
              </div>
            </motion.div>
          ))}
